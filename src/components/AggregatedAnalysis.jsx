...
export default function AggregatedAnalysis({ rules, selectedRuleId, allSelectedRuleId, onDrillToHistorical, onRuleClick }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    // no separate memoization/dependency to keep in sync.
    const validate = () => {
